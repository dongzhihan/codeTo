  ...
  (
    ...
    (goog.needsTranspile_ = function(a) {
      ...
      if (!goog.transpiledLanguages_) {
        ...
        try {
          (goog.transpiledLanguages_.es5 = eval("[1,].length!=1")), eval(
...
goog.getCssName = function(a, b) {
  ...
  var c = function(a) {
    ...
    d = goog.cssNameMapping_
      ? "BY_WHOLE" == goog.cssNameMappingStyle_ ? c : d
      : function(a) {
          return a;
        },
    d = b ? a + "-" + d(b) : d(a);
...
goog.string.numberAwareCompare_ = function(a, b, c) {
  ...
  for (
    ...
    var h = e[g];
    if (c != h)
      return (a = parseInt(c, 10)), !isNaN(a) &&
      ((b = parseInt(h, 10)), !isNaN(b) && a - b)
        ? a - b
        : c < h ? -1 : 1;
  }
...
goog.string.htmlEscape = function(a, b) {
  if (b)
    (a = a
      ...
      .replace(goog.string.NULL_RE_, "&#0;")), goog.string
      .DETECT_DOUBLE_ESCAPING && (a = a.replace(goog.string.E_RE_, "&#101;"));
  else {
...
goog.string.parseInt = function(a) {
  ...
  return goog.isString(a)
    ? /^\s*-?0x/i.test(a) ? parseInt(a, 16) : parseInt(a, 10)
    : NaN;
};
...
goog.object.extend = function(a, b) {
  for (var c, d, e = 1; e < arguments.length; e++) {
    ...
    for (var f = 0; f < goog.object.PROTOTYPE_FIELDS_.length; f++)
      (c =
        goog.object.PROTOTYPE_FIELDS_[f]), Object.prototype.hasOwnProperty.call(
        d,
        c
      ) && (a[c] = d[c]);
  }
...
goog.i18n.bidi.toDir = function(a, b) {
  return "number" == typeof a
    ? 0 < a
      ...
      : 0 > a ? goog.i18n.bidi.Dir.RTL : b ? null : goog.i18n.bidi.Dir.NEUTRAL
...
goog.i18n.bidi.estimateDirection = function(a, b) {
  ...
  return 0 == d
    ? e ? goog.i18n.bidi.Dir.LTR : goog.i18n.bidi.Dir.NEUTRAL
...
goog.html.SafeHtml.combineAttributes = function(a, b, c) {
  var d = {},
    e;
  for (e in a)
    goog.asserts.assert(e.toLowerCase() == e, "Must be lower case"), (d[e] =
      a[e]);
  for (e in b)
    goog.asserts.assert(e.toLowerCase() == e, "Must be lower case"), (d[e] =
      b[e]);
...
goog.math.Rect.prototype.intersection = function(a) {
  ...
  if (b <= c) {
    ...
    if (d <= a)
      return (this.left = b), (this.top = d), (this.width =
        c - b), (this.height = a - d), !0;
  }
  return !1;
};
...
goog.style.getFramedPageOffset = function(a, b) {
  ...
  do {
    ...
    d && d != b && d != d.parent && (e = d.frameElement) && (d = d.parent)
  );
  return c;
};
...
goog.style.getContentBoxSize = function(a) {
  ...
  if (
    ...
    return (b = goog.style.getIePixelValue_(
      a,
      c.width,
      "width",
      "pixelWidth"
    )), (a = goog.style.getIePixelValue_(
      a,
      c.height,
      "height",
      "pixelHeight"
...
goog.style.setBoxSizingSize_ = function(a, b, c) {
  ...
  goog.userAgent.GECKO
    ? (a.MozBoxSizing = c)
    : goog.userAgent.WEBKIT ? (a.WebkitBoxSizing = c) : (a.boxSizing = c);
...
goog.style.getFontSize = function(a) {
  ...
  if (goog.userAgent.IE) {
    ...
    if (
      ...
      return (a = a.parentNode), (c = goog.style.getStyle_(
        a,
        "fontSize"
...
goog.events.getVendorPrefixedName_ = function(a) {
  return goog.userAgent.WEBKIT
    ? "webkit" + a
    : goog.userAgent.OPERA ? "o" + a.toLowerCase() : a.toLowerCase();
};
  ...
  if (g && !goog.events.BrowserFeature.HAS_W3C_EVENT_SUPPORT) {
    if (
      ...
      return goog.asserts.fail(
        "Can not register capture listener in IE8-."
      ), null;
    if (
      goog.events.CAPTURE_SIMULATION_MODE ==
...
goog.events.getListener = function(a, b, c, d, e) {
  ...
  return goog.events.Listenable.isImplementedBy(a)
    ...
    : a
      ? (a = goog.events.getListenerMap_(a)) ? a.getListener(b, c, d, e) : null
      : null;
};
    ...
    if (
      ...
      if (!goog.events.isMarkedIeEvent_(c)) {
        ...
        for (g = 0; !d.propagationStopped_ && g < c.length; g++)
          (d.currentTarget = c[g]), (h = goog.events.fireListeners_(
            c[g],
            f,
            !1,
            d
  ...
  return new goog.Promise(function(b, c) {
    ...
    if (d)
      for (
        ...
        (h = a[g]), goog.Promise.resolveThen_(
          h,
          goog.partial(f, g, !0),
          goog.partial(f, g, !1)
        );
...
goog.ui.Component.defaultRightToLeft_ =
  1 == goog.ui.Component.DEFAULT_BIDI_DIR
    ? !1
    : -1 == goog.ui.Component.DEFAULT_BIDI_DIR ? !0 : null;
...
goog.ui.registry.getDefaultRenderer = function(a) {
  ...
  return b
    ? goog.isFunction(b.getInstance) ? b.getInstance() : new b()
    : null;
};
...
goog.ui.ControlRenderer.prototype.decorate = function(a, b) {
  ...
  goog.array.forEach(
    ...
    function(a) {
      g || a != e
        ? h || a != f ? (d |= this.getStateFromClass(a)) : (h = !0)
        : ((g = !0), f == e && (h = !0));
        ...
        goog.userAgent.IE &&
          (
            ...
            this.ieMouseEventSequenceSimulator_ ||
              (
                (this.ieMouseEventSequenceSimulator_ = new goog.ui.Control
                  .IeMouseEventSequenceSimulator_(this)),
...
goog.ui.Control.IeMouseEventSequenceSimulator_.makeLeftMouseEvent_ = function(
  ...
  if (!goog.ui.Control.IeMouseEventSequenceSimulator_.SYNTHETIC_EVENTS_)
    return (a.button =
      goog.events.BrowserEvent.MouseButton.LEFT), (a.type = b), a;
...
goog.iter.GroupByIterator_.prototype.next = function() {
  for (; this.currentKey == this.targetKey; )
    (this.currentValue = this.iterator.next()), (this.currentKey = this.keyFunc(
      this.currentValue
    ));
...
goog.ui.Palette.prototype.handleKeyEvent = function(a) {
  ...
  switch (a.keyCode) {
    case goog.events.KeyCodes.LEFT:
      ...
      return !0;
    case goog.events.KeyCodes.RIGHT:
      return d == b - 1 && (d = -1), this.setHighlightedIndex(
        d + 1
      ), a.preventDefault(), !0;
    case goog.events.KeyCodes.UP:
      -1 == d && (d = b + c - 1);
...
goog.ui.Palette.prototype.adjustSize_ = function() {
  ...
  if (a)
    if (this.size_ && this.size_.width) {
      ...
      (a = Math.ceil(Math.sqrt(a.length))), (this.size_ = new goog.math.Size(
        a,
        a
      ));
...
goog.structs.Map.prototype.cleanupKeysArray_ = function() {
  ...
  if (this.count_ != this.keys_.length) {
    for (var d = {}, b = (a = 0); a < this.keys_.length; )
      (c = this.keys_[a]), goog.structs.Map.hasKey_(d, c) ||
        ((this.keys_[b++] = c), (d[c] = 1)), a++;
    this.keys_.length = b;
  }
};
...
goog.debug.Logger.Level.createPredefinedLevelsCache_ = function() {
  ...
  for (var a = 0, b; (b = goog.debug.Logger.Level.PREDEFINED_LEVELS[a]); a++)
    (goog.debug.Logger.Level.predefinedLevelsCache_[
      b.value
    ] = b), (goog.debug.Logger.Level.predefinedLevelsCache_[b.name] = b);
};
...
Blockly.Connection = function(a, b) {
  ...
  a.workspace.connectionDBList &&
    (
      ...
      (this.dbOpposite_ =
        a.workspace.connectionDBList[Blockly.OPPOSITE_TYPE[b]]),
...
Blockly.ConnectionDB.prototype.searchForClosest = function(a, b, c) {
  ...
  for (var g = b, h, k = f - 1; 0 <= k && this.isInYRange_(k, a.y_, b); )
    (h = this[k]), a.isConnectionAllowed(h, g) &&
      ((c = h), (g = h.distanceFrom(a))), k--;
  for (; f < this.length && this.isInYRange_(f, a.y_, b); )
    (h = this[f]), a.isConnectionAllowed(h, g) &&
      ((c = h), (g = h.distanceFrom(a))), f++;
  a.x_ = e;
  a.y_ = d;
...
Blockly.Options = function(a) {
  ...
  if (b)
    ...
    (c = Blockly.Options.parseToolboxTree(a.toolbox)), (d = !(
      !c || !c.getElementsByTagName("category").length
    )), (e = a.trashcan), void 0 === e && (e = d), (f = a.collapse), void 0 ===
      f && (f = d), (g = a.comments), void 0 === g && (g = d), (h =
      a.disable), void 0 === h && (h = d), (k = a.sounds), void 0 === k &&
      (k = !0);
  var m = !!a.rtl,
  ...
  var l = a.toolboxPosition,
    l = "end" === l ? !1 : !0,
    l = p
      ? l ? Blockly.TOOLBOX_AT_TOP : Blockly.TOOLBOX_AT_BOTTOM
      : l == m ? Blockly.TOOLBOX_AT_RIGHT : Blockly.TOOLBOX_AT_LEFT,
    n = a.scrollbars;
  void 0 === n && (n = d);
  var q = a.css;
  void 0 === q && (q = !0);
...
Blockly.Xml.blockToDom = function(a) {
  ...
  if ((c = a.getCommentText()))
    (c = goog.dom.createDom("comment", null, c)), "object" ==
      typeof a.comment &&
      (
  ...
  if ((c = a.getNextBlock()))
    (h = goog.dom.createDom(
      "next",
      null,
      Blockly.Xml.blockToDom(c)
    )), b.appendChild(h);
...
Blockly.Xml.cloneShadow_ = function(a) {
  for (var b = (a = a.cloneNode(!0)), c; b; )
    if (b.firstChild) b = b.firstChild;
      ...
      for (; b && !b.nextSibling; )
        (c = b), (b = b.parentNode), 3 == c.nodeType &&
          "" == c.data.trim() &&
          b.firstChild != c &&
          goog.dom.removeNode(c);
      b &&
...
Blockly.WorkspaceSvg.prototype.isDeleteArea = function(a) {
  ...
  if (this.deleteAreaTrash_) {
    if (this.deleteAreaTrash_.contains(a))
      return this.trashcan.setOpen_(!0), Blockly.Css.setCursor(
        Blockly.Css.Cursor.DELETE
      ), !0;
    ...
    if (this.options.collapse) {
      ...
      var p = function(a) {
          for (var b = 0, c = 0; c < e.length; c++)
            for (var d = e[c]; d; )
              setTimeout(
                d.setCollapsed.bind(d, a),
                b
              ), (d = d.getNextBlock()), (b += 10);
        },
        h = { enabled: h };
      ...
      (
        ...
        (c =
          (goog.userAgent.DOCUMENT_MODE &&
            9 === goog.userAgent.DOCUMENT_MODE) ||
          goog.userAgent.IPAD ||
...
Blockly.WorkspaceSvg.prototype.zoom = function(a, b, c) {
  ...
  this.scale != c &&
    (
      this.scrollbar &&
        (
          (a = f.getCTM().translate(a * (1 - d), b * (1 - d)).scale(d)),
...
Blockly.Mutator.prototype.resizeBubble_ = function() {
  ...
  if (
    ...
    (this.workspaceWidth_ = c), (this.workspaceHeight_ = b), this.bubble_.setBubbleSize(
      c + a,
      b + a
...
Blockly.Mutator.prototype.setVisible = function(a) {
  if (a != this.isVisible())
    if (
      ...
      (this.svgDialog_ = null), this.workspace_.dispose(), (this.rootBlock_ = this.workspace_ = null), this.bubble_.dispose(), (this.bubble_ = null), (this.workspaceHeight_ = this.workspaceWidth_ = 0), this
        .sourceListener_ &&
        (
    ...
    if (
      ...
      if (this.block_.RTL)
        for (var b = a.getBBox().width, c = 0, d; (d = a.childNodes[c]); c++)
          d.setAttribute("text-anchor", "end"), d.setAttribute(
            "x",
            b + Blockly.Bubble.BORDER_WIDTH
          );
      this.updateColour();
...
Blockly.Block.prototype.setConnectionsHidden = function(a) {
  if (!a && this.isCollapsed()) {
    ...
    for (var c = this.getConnections_(!0), d = 0; (b = c[d]); d++)
      b.setHidden(a), b.isSuperior() &&
        (b = b.targetBlock()) &&
        b.setConnectionsHidden(a);
};
...
Blockly.BlockSvg.prototype.tab = function(a, b) {
  ...
  -1 == d && (d = b ? -1 : c.length);
  (c = c[b ? d + 1 : d - 1])
    ? c instanceof Blockly.Field ? c.showEditor_() : c.tab(null, b)
  ...
  if (
    ...
    if (Blockly.dragMode_ == Blockly.DRAG_FREE) {
      ...
      for (c = 0; c < this.draggedBubbles_.length; c++)
        (d = this.draggedBubbles_[c]), d.bubble.setIconLocation(
          goog.math.Coordinate.sum(d, b)
        );
...
Blockly.BlockSvg.prototype.updateColour = function() {
  if (!this.disabled) {
    ...
    if (this.isShadow())
      (b = goog.color.lighten(b, 0.6)), (a = goog.color.rgbArrayToHex(
        b
      )), (this.svgPathLight_.style.display =
        "none"), this.svgPathDark_.setAttribute("fill", a);
    else {
      this.svgPathLight_.style.display = "";
...
Blockly.BlockSvg.prototype.setWarningText = function(a, b) {
  ...
  if (c)
    ...
    for (var d in this.setWarningText.pid_)
      clearTimeout(this.setWarningText.pid_[d]), delete this.setWarningText
        .pid_[d];
  if (Blockly.dragMode_ == Blockly.DRAG_FREE) {
    var e = this;
    ...
    goog.isString(a)
      ? (
          this.warning ||
            ((this.warning = new Blockly.Warning(this)), (d = !0)),
...
Blockly.BlockSvg.prototype.renderDrawRight_ = function(a, b, c, d, e, f) {
  for (var g, h = 0, k, m, p = 0, l; (l = e[p]); p++) {
    ...
    if (this.isCollapsed()) {
      ...
      for (var q = 0; (n = l[q]); q++)
        (k = h), l.thicker &&
          (k += Blockly.BlockSvg.INLINE_PADDING_Y), (g = this.renderFields_(
          n.fieldRow,
          g,
          k
        )), n.type != Blockly.DUMMY_INPUT &&
          (g += n.renderWidth + Blockly.BlockSvg.SEP_SPACE_X), n.type ==
          Blockly.INPUT_VALUE &&
          (
            c.push(
              "M",
            ...
            this.RTL
              ? (
                  ...
                  d.push(
                    "v",
                    n.renderHeight - Blockly.BlockSvg.TAB_HEIGHT + 2.5
                  ),
              ...
              : (
                  b.push(
                    ...
                    e.rightEdge -
                      5 +
                      "," +
                      (h + Blockly.BlockSvg.TAB_HEIGHT - 0.7)
                  ),
...
Blockly.Events.Create.prototype.run = function(a) {
  ...
  if (a)
    (a = goog.dom.createDom("xml")), a.appendChild(
      this.xml
...
Blockly.Events.Change.prototype.run = function(a) {
  var b = Blockly.Workspace
    .getById(this.workspaceId)
    .getBlockById(this.blockId);
  if (b)
    switch ((
...
Blockly.FieldTextInput.prototype.showEditor_ = function(a) {
  ...
  if (
    ...
    (a = window.prompt(Blockly.Msg.CHANGE_VALUE_TITLE, this.text_)), this
      .sourceBlock_ && (a = this.callValidator(a)), this.setValue(a);
  else {
  ...
  isNaN(b) ||
    (
      ...
      Blockly.FieldAngle.ROUND &&
        (b =
          Math.round(b / Blockly.FieldAngle.ROUND) * Blockly.FieldAngle.ROUND),
...
Blockly.FieldDropdown.prototype.showEditor_ = function() {
  ...
  goog.events.listen(b, goog.ui.Component.EventType.ACTION, function(b) {
    if ((b = b.target))
      (b = b.getValue()), a.sourceBlock_ && (b = a.callValidator(b)), null !==
        b && a.setValue(b);
...
Blockly.Generator.prototype.blockToCode = function(a) {
  ...
  if (goog.isString(b))
    return this.STATEMENT_PREFIX &&
      (b =
        this.STATEMENT_PREFIX.replace(/%1/g, "'" + a.id + "'") +
        b), this.scrub_(a, b);
  if (null === b) return "";
  ...
  for (var c = 0, e; (e = a[c]); c++) {
    ...
    f != g &&
      (
        (Blockly.Events.recordUndo = !1),
        Blockly.Events.fire(
          new Blockly.Events.Change(e, "mutation", null, f, g)
        ),
...
Blockly.Flyout.prototype.getMetrics_ = function() {
  ...
  if (this.horizontalLayout_) {
    ...
    (c = 0), (d = this.height_ - 2 * this.SCROLLBAR_PADDING), (e = this
      .width_), this.RTL || (e -= this.SCROLLBAR_PADDING);
  return {
    viewHeight: d,
    viewWidth: e,
    ...
    for (c = 0; (d = a[c]); c++) {
      ...
      d.flyoutRect_ &&
        (
          ...
          d.flyoutRect_.setAttribute(
            "x",
            this.RTL ? f.x - e.width + g : f.x - g
          ),
          (e = d.startHat_ ? Blockly.BlockSvg.START_HAT_HEIGHT : 0) &&
            d.moveBy(0, e),
...
Blockly.onKeyDown_ = function(a) {
  if (!Blockly.mainWorkspace.options.readOnly && !Blockly.isTargetInput_(a)) {
    ...
    if (27 == a.keyCode) Blockly.hideChaff();
      ...
      a.preventDefault(), Blockly.selected &&
        Blockly.selected.isDeletable() &&
        (b = !0);
      ...
      Blockly.selected &&
        ...
        (67 == a.keyCode
          ...
          : 88 == a.keyCode &&
            (Blockly.copy_(Blockly.selected), (b = !0))), 86 == a.keyCode
