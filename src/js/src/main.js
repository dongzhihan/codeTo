...
window.dbStructure = dbStructure; // Global Database Structure
window.editor = editor; // Global SQL Code Editor variable
window.selected = selected; // Object of the element to be moved
window.x_pos = x_pos;
window.y_pos = y_pos; // Stores x & y coordinates of the mouse pointer
window.x_elem = x_elem;
window.y_elem = y_elem; // Stores top, left values (edge) of the element